...
public class MainWindow extends JFrame {
	...
	private JMenuBar menuBar() {
		...
		JMenuItem easyMode = new JMenuItem("Abilita modalita' facile");
		this.easyMode = easyMode;
		easyMode.addActionListener(event -> {
			view.setMode();
			if (easyMode.getText().equals("Abilita modalita' facile"))
				easyMode.setText("Disabilita modalita' facile");
			else
				easyMode.setText("Abilita modalita' facile");
				
		});
		
		optionMenu.add(easyMode);
