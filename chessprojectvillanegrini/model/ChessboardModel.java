...
import chessprojectvillanegrini.model.pieces.*;
...
public class ChessboardModel implements ModelController, ModelPieces {
	...
	public void coordinates(int x, int y) {
		...
		case GOTO: // caso attesa coordinate di arrivo
			...
			// se sono in modalita' facile e clicco su un mio pezzo con mosse disponibili diverso 
			// da quello precedentemente gia' scelto cambio pezzo con cui giocare selezionando l'ultimo scelto
			if (easyMode && chessboard[x][y] != null && chessboard[x][y].getTeam() == turn && availableMoves(x, y).iterator().hasNext()) {	
				step = Step.STARTFROM;
