...
public class Pawn extends Piece {
	...
	public Pawn(Team team, Model chessboard) {
	...
	public Iterable<Integer> mosseConsentite(int x, int y) {
		...
		if (this.team == Team.TEAM1) {//team1 va verso l'alto
			...
			if (x < 7 && y < 7 &&
					( ((other = chessboard.getPiece(x + 1, y + 1)) != null && other.team != team) || enpassant(x, y, true) ))
			...
			if (x > 0 && y < 7 && 
					( ((other = chessboard.getPiece(x - 1, y + 1)) != null && other.team != team) || enpassant(x, y, false) ))
				mosseConsentite.add((x - 1) * 10 + (y + 1));//aggiungo quella casella alle consentite
		} 
