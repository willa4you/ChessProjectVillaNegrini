...
public class Knight extends Piece {
	...
	public Iterable<Integer> mosseConsentite(int x, int y) {
		...
		if (y < 7 && x < 6 && (((other = ChessboardModel2.getPezzoInPosizione(x + 2, y + 1)) == null) || other .team != team))
			mosseConsentite.add((x + 2) * 10 + (y + 1));//aggiungo quella casella alle consentite
		//seconda mossa partendo da radianti 0
		if (y < 6 && x < 7 && (((other = ChessboardModel2.getPezzoInPosizione(x + 1, y + 2)) == null) || other .team != team))
			mosseConsentite.add((x + 1) * 10 + (y + 2));//aggiungo quella casella alle consentite		
		//terza mossa partendo da radianti 0
		if (y < 6 && x > 0 && (((other = ChessboardModel2.getPezzoInPosizione(x - 1, y + 2)) == null) || other .team != team))
			mosseConsentite.add((x - 1) * 10 + (y + 2));//aggiungo quella casella alle consentite		
		//quarta mossa partendo da radianti 0
		if (y < 7 && x > 1 && (((other = ChessboardModel2.getPezzoInPosizione(x - 2, y + 1)) == null) || other .team != team))
			mosseConsentite.add((x - 2) * 10 + (y + 1));//aggiungo quella casella alle consentite			
		//quinta mossa partendo da radianti 0
		if (y > 0 && x > 1 && (((other = ChessboardModel2.getPezzoInPosizione(x - 2, y - 1)) == null) || other .team != team))
			mosseConsentite.add((x - 2) * 10 + (y - 1));//aggiungo quella casella alle consentite
		//sesta mossa partendo da radianti 0
		if (y > 1 && x > 0 && (((other = ChessboardModel2.getPezzoInPosizione(x - 1, y - 2)) == null) || other .team != team))
			mosseConsentite.add((x - 1) * 10 + (y - 2));//aggiungo quella casella alle consentite
		//settima mossa partendo da radianti 0
		if (y > 1 && x < 7 && (((other = ChessboardModel2.getPezzoInPosizione(x + 1, y - 2)) == null) || other .team != team))
			mosseConsentite.add((x + 1) * 10 + (y - 2));//aggiungo quella casella alle consentite
		//ottava mossa partendo da radianti 0 (e chiudendo la circonferenza)
		if (y > 0 && x < 6 && (((other = ChessboardModel2.getPezzoInPosizione(x + 2, y - 1)) == null) || other .team != team))
			mosseConsentite.add((x + 2) * 10 + (y - 1));//aggiungo quella casella alle consentite
