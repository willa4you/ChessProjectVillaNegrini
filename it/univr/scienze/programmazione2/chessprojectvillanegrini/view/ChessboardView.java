...
import it.univr.scienze.programmazione2.chessprojectvillanegrini.controller.ChessController;
import it.univr.scienze.programmazione2.chessprojectvillanegrini.controller.Controller;
...
public class ChessboardView extends JPanel implements View {
	...
	// le coordinate dell'ultima casella errata selezionata
	...
	public void wrongMove(int x, int y) {		
		...
		wrongX = x; // le salvo per togliere l'higlight rosso
		wrongY = y; // al prossimo eventuale errore
		buttons[x][y].wrong();
	}
