...
public class Pedone extends Pezzo {
	...
	public Iterable<Integer> mosseConsentite(byte x, byte y) {
		...
		if(x + 1 <= 7 && y + 1 <= 7 && (other = Scacchiera.getPezzoInPosizione((byte)(x + 1), (byte)(y + 1)).squadra) != squadra && other != null)
		...
		if(x - 1 >= 0 && y + 1 <= 7 && (other = Scacchiera.getPezzoInPosizione((byte)(x - 1), (byte)(y + 1)).squadra) != squadra && other != null)
			mosseConsentite.add((int)((x-1)*10 + y + 1));//aggiungo quella casella alle consentite
		
		//per muovermi in alto non devo uscire e dev'essere casella vuota
		if(y + 1 <= 7 && Scacchiera.getPezzoInPosizione((byte)(x), (byte)(y + 1)) == null)
